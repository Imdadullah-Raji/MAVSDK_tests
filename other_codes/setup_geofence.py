...
async def run():
    ...
    p1 = Point(latitude - 0.002, longitude - 0.002)
    p2 = Point(latitude + 0.002, longitude - 0.002)
    p3 = Point(latitude + 0.002, longitude + 0.002)
    p4 = Point(latitude - 0.002, longitude + 0.002)

    # Create a polygon object using your points
    polygon = Polygon([p1, p2, p3, p4], FenceType.INCLUSION)

    circle = Circle(Point(latitude,longitude), 120.0, FenceType.INCLUSION)
